...
<div class="container-gallery">
  <div class="orbit" data-orbit data-options="animInFromLeft:fade-in; animInFromRight:fade-in; animOutToLeft:fade-out; animOutToRight:fade-out;">
    <div class="orbit-container">
        	...
        	<img class="orbit-image" src="<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/gallery-full/gallery-1.jpg" alt="The Kingsley Photo Gallery" />
        	<figcaption class="orbit-caption"></figcaption>
      	</div>

		<div class="orbit-slide">
		<img class="orbit-image" src="<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/gallery-full/gallery-2.jpg" alt="The Kingsley Photo Gallery" />
        	<figcaption class="orbit-caption"></figcaption>
      	</div>

		<div class="orbit-slide">
			<img class="orbit-image" src="<?php echo get_stylesheet_directory_uri(); ?>/dist/assets/images/gallery-full/gallery-3.jpg" alt="The Kingsley Photo Gallery" />
        	<figcaption class="orbit-caption"></figcaption>
      	</div>
